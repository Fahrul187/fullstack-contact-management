...
export default function ContactList() {
    ...
    useEffect(() => {
        fetchContacts()
            .then(() => console.log("Contacts fatched"));
    }, [reload])
    ...
    return <>
        <div>
            ...
            {/* Search form */}
            <div className="bg-gray-800/80 rounded-xl shadow-custom border border-gray-700 p-6 mb-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-gray-800/80 rounded-xl shadow-custom overflow-hidden border-2 border-dashed border-gray-700 card-hover animate-fade-in">
                ...
                {contacts.map(contact => (
                    ...
                    <div key={contact.id} className="bg-gray-800/80 rounded-xl shadow-custom border border-gray-700 overflow-hidden card-hover animate-fade-in">
                        <div className="p-6">
            ...
            <div className="mt-10 flex justify-center">
                <nav className="flex items-center space-x-3 bg-gray-800/80 rounded-xl shadow-custom border border-gray-700 p-3 animate-fade-in">
                    {page > 1 &&
