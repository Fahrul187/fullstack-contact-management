...
export default function ContactDetail() {
    ...
    async function handleDeleteAddress(addressId) {
        if (!await alertConfirm("Are you sureyou want to delete this address?")) {
            return;
        }
            ...
            <div className="bg-gray-800/80 rounded-xl shadow-custom border border-gray-700 overflow-hidden max-w-2xl mx-auto animate-fade-in">
                <div className="p-8">
                    ...
                    <div className="mb-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            {/* Add Address Card */}
                            <div className="bg-gray-700/50 p-5 rounded-lg border-2 border-dashed border-gray-600 shadow-md card-hover">
                            ...
                            {addresses.map(address => (
                                <div key={address.id} className="bg-gray-700/50 p-5 rounded-lg shadow-md border border-gray-600 card-hover">
